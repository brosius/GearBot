...
public class MagFieldGraphPanel extends JPanel {
    ...
    public MagFieldGraphPanel() {
        this.setBorder(javax.swing.BorderFactory.createTitledBorder("Magnetic Field Vector"));
